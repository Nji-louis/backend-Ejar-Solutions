...
router.get("/hero", verifyToken, verifyAdmin, (req, res) => {
...
router.get("/public/hero", (req, res) => {
    ...
    db.query(
        ...
        "SELECT * FROM hero_slides WHERE status='active' ORDER BY sort_order ASC",
...
router.get("/about", verifyToken, verifyAdmin, (req, res) => {

    db.query(
        "SELECT * FROM homepage_about LIMIT 1",
        (err, results) => {
